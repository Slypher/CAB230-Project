...
<html>
    ...
    <body>
        ...
        <div id="page-container">
            <?php if (isset($query['login'])) echo '<div class="success-message"><span class="fa fa-check"></span> Login successful</div>'; ?>
            <?php if (isset($query['register'])) echo '<div class="success-message"><span class="fa fa-check"></span> Registration successful</div>'; ?>
            <!-- SECTION 2: Content -->
            <div id="content">
